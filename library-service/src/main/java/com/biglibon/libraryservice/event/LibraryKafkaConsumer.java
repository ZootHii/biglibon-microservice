...
public class LibraryKafkaConsumer {
    ...
    public LibraryKafkaConsumer(KafkaEventDispatcher dispatcher, ObjectMapper objectMapper) {
        this.dispatcher = dispatcher;
        this.objectMapper = objectMapper;
    }

    @KafkaListener(
            topics = {KafkaConstants.Book.TOPIC},
            groupId = KafkaConstants.Library.CONSUMER_GROUP
    )
    public void listen(ConsumerRecord<String, String> record) {
        ...
        try {
            ...
            kafkaEvent.setConsumerGroup(KafkaConstants.Library.CONSUMER_GROUP);
            log.info("KafkaEvent received | Topic: {}, Event: {}, ConsumerGroup: {}, Payload: {}",
                    topic, kafkaEvent.getEvent(), KafkaConstants.Library.CONSUMER_GROUP, kafkaEvent.getPayload());
